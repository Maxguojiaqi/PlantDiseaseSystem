...
var $url2 = "http://ulysses.gis.agr.gc.ca:8080/geoserver/rest/workspaces/PlantDisease/coveragestores/"
var $url = "http://ulysses.gis.agr.gc.ca:8080/geoserver/rest/workspaces/PlantDisease/layergroups.json"
                    ...
                    $('#layer-group-acc').append('<div id="' + $lGName + '" class="title">' + 
                                                 ...
                                                 '<div class="content">' +
                                                    ...
                                                    ' class="layer-dropdown ui fluid dropdown multiple selection">' +
                                                        '<option value="">PlantDisease data</option>' +
                                                    '</select>' +
                                                 '</div>');
